<template>
  <div class="wpp-app">
    <section :style="sectionStyle">
      ...
      >
        <div v-if="isOpen" class="wpp-app-box">
          <div class="wpp-app-box-header">
            <h2>
          ...
          <Form />
          <p class="wpp-app-copyright">
            <small>Powered by Traction</small>
          </p>
        </div>
      </transition>
      <a @click="isOpen = !isOpen" class="cta">
        <img
          width="64"
  ...
  computed: {
    sectionStyle() {
      return {
        ...
        marginBottom: (this.$wppConfig.bottom || 20) + 'px',
        zIndex: 99999,
      }
    },
  },
...
.wpp-app-box-header {
  @apply bg-green-500 p-6 rounded-t-xl text-white;
}
h2 {
...
.cta {
  @apply block p-4 text-green-500 cursor-pointer;
}
.cta:hover {
